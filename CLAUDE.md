...
## 0.5 Design before code

Before writing a single line of HTML, CSS, or JavaScript, solve the design problem.

Internally answer these questions first:
...
- What is the single visual idea that should be remembered after closing the page?

Do not begin implementation until these questions have clear answers.

Design systems exist to communicate meaning, not decorate interfaces.
...
## 2.5 Understand the industry

Different industries require different visual language.

Never force startup aesthetics onto businesses that require trust,
credibility, precision, or authority.
...
These should feel restrained, structured, technically competent,
and intentionally understated.

Creative agencies may justify expressive layouts.

Consumer brands may justify bold color.

Technology companies may justify experimentation.

Choose the visual language that belongs to the industry—not the one that is easiest to generate.
...
Hierarchy should exist before decoration.

The viewer's eye should naturally know:
...
A page should remain understandable even if displayed entirely in grayscale.
...
Never rely on generic stock photography.
...
- handshakes
- abstract 3D blobs
- fake AI-generated business people
- meaningless city skylines

Instead choose imagery that directly represents the subject.
...
If suitable photography does not exist, recommend what should be photographed rather than filling the page with unrelated imagery.
...
## 5.5 Avoid repetition

Generated websites often repeat the same visual solution.
...
Every section should earn its own structure.
...
Consistency comes from typography, spacing, and color—not repeating boxes.
...
Animation should explain interface behavior—not advertise that animation exists.
...
Avoid large animation libraries unless they meaningfully improve the experience.

A beautiful website that loads slowly is unfinished.
...
Write like an expert in the subject.
...
These should form a coherent system.

Avoid arbitrary values chosen section-by-section.
...
7. Pretend another experienced design studio is reviewing this work.

List every weakness they would notice.

Improve the design.

Repeat until no obvious AI-generated patterns remain.
...
## 9.5 Signs of studio-quality work

A finished website should contain:

- one memorable visual idea
- one signature layout decision
- one intentional typography system
- one consistent spacing rhythm
- one restrained color palette
- one interaction users remember

If another company's logo could be swapped in without redesigning the page, the design is too generic.

Every project should contain at least one idea that belongs uniquely to that client.
...
Good design is rarely louder.

It is usually clearer.

Do not optimize for novelty.

Do not optimize for awards.

Optimize for appropriateness.

The website should feel inevitable—as though no other design could belong to this company.

Restraint ages well.

Specificity creates identity.

Every design decision should have a reason beyond aesthetics.

If you cannot explain why something exists, remove it.
